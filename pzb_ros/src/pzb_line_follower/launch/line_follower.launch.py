...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('linear_speed',  default_value='0.06',
                              description='Forward speed in m/s'),
        DeclareLaunchArgument('Kp_straight',    default_value='0.002',
                              description='Proportional steering gain (rad/s per px)'),
        DeclareLaunchArgument('Kd_straight',    default_value='0.001',
                              description='Derivative steering gain (rad/s per px/frame); 0 disables'),
        DeclareLaunchArgument('Kp_curve',    default_value='0.0025',
                              description='Proportional steering gain (rad/s per px)'),
        DeclareLaunchArgument('Kd_curve',    default_value='0.0015',
                              description='Derivative steering gain (rad/s per px/frame); 0 disables'),
        ...
        Node(
            ...
            parameters=[
                lf_params,
                {
                    ...
                    'Kp_straight':           LaunchConfiguration('Kp_straight'),
                    'Kp_straight':           LaunchConfiguration('Kp_straight'),
                    'Kp_curve':              LaunchConfiguration('Kp_curve'),
                    'Kp_curve':              LaunchConfiguration('Kp_curve'),
